...
lenaRGB = imread("images/lenaRGB.png");

imgR = lenaRGB(:, :, 1);
imgG = lenaRGB(:, :, 2);
imgB = lenaRGB(:, :, 3);

msg1 = imread("mensagens/msgEscondida1.png");
msg2 = imread("mensagens/msgEscondida2.png");
msg3 = imread("mensagens/msgEscondida3.png");
